  ...
  <body>
    ...
    <script>
        ...
        $('.add-row').click(function(e){
            e.preventDefault();
            let service_name = $('#id_paket').find('option:selected').text(),
            ...
            let newRow = "";
           newRow += "<tr>";
           newRow += "<td>"+ service_name +"<input type='hidden' name='id_paket[]' class='id_paket form-control' value='" + id_paket + "'></td>";
           newRow += "<td>" + harga + "<input type='hidden' name='price_service[]' id='qty' value='" + harga +"'></td>";
